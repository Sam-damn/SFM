...
class SfmManyViews : public ISfmManyViews {
...
public :
	...
	std::vector<CloudPoint> getPointCloud_raw() { return pcloud; }
	...
	SfmManyViews(const std::vector<cv::Mat>& imgs_,
